        ...
        .then(function (response) {
            ...
            if (Array.isArray(coursData) && coursData.length > 0) {
                ...
                Object.entries(groupedData).forEach(([nomCours, coursArray]) => {
                    ...
                    console.log(coursArray[0]);
                    // Storing the values in variables
                    const totalComp1 = coursArray[0].totalComp1;
                    const totalComp2 = coursArray[0].totalComp2;
                    const totalComp3 = coursArray[0].totalComp3;

                    // Create a new row for totals
                    const totalsRow = document.createElement('tr');

                    // Create a cell that spans two columns with the text "Total Cours"
                    const totalCoursLabelCell = document.createElement('td');
                    totalCoursLabelCell.textContent = "Total Cours";
                    totalCoursLabelCell.colSpan = 2; // Make it span two columns
                    totalsRow.appendChild(totalCoursLabelCell);

                    // Creating and appending the cell for totalComp1
                    const totalComp1Cell = document.createElement('td');
                    totalComp1Cell.textContent = totalComp1;
                    totalComp1Cell.style.textAlign = 'center';
                    totalComp1Cell.style.fontWeight = 'bold';
                    totalsRow.appendChild(totalComp1Cell);

                    // Creating and appending the cell for totalComp2
                    const totalComp2Cell = document.createElement('td');
                    totalComp2Cell.textContent = totalComp2;
                    totalComp2Cell.style.textAlign = 'center';
                    totalComp2Cell.style.fontWeight = 'bold';
                    totalsRow.appendChild(totalComp2Cell);

                    // Creating and appending the cell for totalComp3
                    const totalComp3Cell = document.createElement('td');
                    totalComp3Cell.textContent = totalComp3;
                    totalComp3Cell.style.textAlign = 'center';
                    totalComp3Cell.style.fontWeight = 'bold';
                    totalsRow.appendChild(totalComp3Cell);
